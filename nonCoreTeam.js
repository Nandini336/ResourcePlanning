...
$(document).ready(function() {
    ...
    $(".mileSubmit").click(function() {
        ...
        if (mileDesc != "" && mileStart != "" && mileEnd != "" && statusMile != "ChooseStatus") {
            var addMilestone = addMileListItem(siteMainUrl, "Milestones_NonCoreTeam", lkaddFieldValue, lkaddRoleValue, lkaddProjectValue, mileDesc, mileStart, mileEnd, lkaddStatusValue, mileComment, month_mile, mile_year)
...
function updateEditDate(siteMainUrl, itemId, saveStart, saveDesc, saveEnd, lkSaveValue, saveComment, month_Editmile, mileEditYear) {
    ...
    var oList = clientContext.get_web().get_lists().getByTitle('Milestones_NonCoreTeam');
...
function getDeleteData(SiteUrl, saveId) {
    ...
    this.oList = clientContext.get_web().get_lists().getByTitle('Milestones_NonCoreTeam');
...
function loadlist() {
    ...
    var oDataUrl = siteUrl + "/_vti_bin/listdata.svc/Names_NonCoreTeam";
    $.ajax({
        url: oDataUrl,
        type: "GET",
        dataType: "json",
...
function loadRolesSearchMilelist() {
    ...
    var siteUrl = _spPageContextInfo.webServerRelativeUrl;
    var oDataUrl = siteUrl + "/_vti_bin/listdata.svc/Roles_NonCoreTeam";
    $.ajax({
        url: oDataUrl,
        type: "GET",
        dataType: "json",
...
function getSavedSubmitData(SiteUrl, addFieldValue, addRoleValueText, monthField, yearField) {
    ...
    var clientContext = new SP.ClientContext(SiteUrl);
    var oList = clientContext.get_web().get_lists().getByTitle('Data_NonCoreTeam');
    var camlQuery = new SP.CamlQuery();
...
function addDataintoList(siteMainUrl, lkaddFieldValue, lkaddRoleValue, addSiteValue, stringDate, monthField, yearField, itemID, newDateFieldRange, deliveryNoteDataField, cylScanDataField, scmDataField, qBotDataField, iBotDataField, datalakeDataField, rpaDataField, ioTDataField, enterprisePortalDataField,agencyDataField,allProjectsDataField,onLeaveDataField) {
    ...
    if (itemID == 0) {
        ...
        var resultAdd = addListItem(siteMainUrl, "Data_NonCoreTeam", lkaddFieldValue, lkaddRoleValue, addSiteValue, stringDate, monthField, yearField);
        ...
        var resultAdd = updateListItem(siteMainUrl, "Data_NonCoreTeam", addSiteValue, stringDate, monthField, yearField, itemID, newDateFieldRange, deliveryNoteDataField, cylScanDataField, scmDataField, qBotDataField, iBotDataField, datalakeDataField, rpaDataField, ioTDataField, enterprisePortalDataField,agencyDataField,allProjectsDataField,onLeaveDataField);
...
function addListItem(siteUrl, lstName, lkaddFieldValue, lkaddRoleValue, addSiteValue, tempDate, month_value, yearField) {
    ...
    if (addSiteValue == "Delivery Note") {
        if (tempDate != "") {
			...
			oListItem.set_item("DeliveryNote_Days",countDays);
        } else {
             oListItem.set_item("DeliverNote", "");oListItem.set_item("DeliveryNote_Days","");
    ...
    if (addSiteValue == "CylScan") {
        if (tempDate != "") {
			...
			oListItem.set_item("CylScan_Days", countDays);
        } else {
             oListItem.set_item("CylScan", "");oListItem.set_item("CylScan_Days","");
        }
    }
    ...
    if (addSiteValue == "SCM FM") {
        if (tempDate != "") {
			...
			oListItem.set_item("SCM_Days", countDays);
        } else {
            oListItem.set_item("SCM_x0020_FM", "");oListItem.set_item("SCM_Days","");
        }
    }
    if (addSiteValue == "QBot") {
        if (tempDate != "") {
			...
			oListItem.set_item("QBot_Days", countDays);
        } else {
            oListItem.set_item("QBot", "");oListItem.set_item("QBot_Days","");
        }
    }
    if (addSiteValue == "IBot") {
        if (tempDate != "") {
			...
			oListItem.set_item("IBot_Days", countDays);
        } else {
           oListItem.set_item("IBot", "");oListItem.set_item("IBot_Days","");
        }
    }
    if (addSiteValue == "DataLake") {
        if (tempDate != "") {
			...
			oListItem.set_item("DataLake_Days",countDays);
			
        } else {
           oListItem.set_item("DataLake", "");oListItem.set_item("DataLake_Days","");
        }
    }
    if (addSiteValue == "RPA") {
        if (tempDate != "") {
			...
			oListItem.set_item("RPA_Days", countDays);
        } else {
            oListItem.set_item("RPA", "");oListItem.set_item("RPA_Days","");
        }
    }
    if (addSiteValue == "IoT") {
        if (tempDate != "") {
			...
			oListItem.set_item("IoT_Days", countDays);
			
        } else {
             oListItem.set_item("IoT", "");oListItem.set_item("IoT_Days", "");
        }
    }
    if (addSiteValue == "Enterprise Portal") {
        if (tempDate != "") {
			...
			oListItem.set_item("EnterprisePortal_Days", countDays);
        } else {
            oListItem.set_item("Enterprise_x0020_Portal", "");oListItem.set_item("EnterprisePortal_Days", "");
        }
    }
	if (addSiteValue == "Agency") {
        if (tempDate != "") {
			...
			oListItem.set_item("Agency_Days", countDays);
        } else {
            oListItem.set_item("Agency", "");oListItem.set_item("Agency_Days", "");
        }
    }
	...
	if (addSiteValue == "All Projects") {
        if (tempDate != "") {
			...
			oListItem.set_item("AllProjects_Days", countDays);
        } else {
            oListItem.set_item("AllProjects", "");oListItem.set_item("AllProjects_Days","");
        }
    }
	...
	if (addSiteValue == "OnLeave") {
        if (tempDate != "") {
			...
			oListItem.set_item("OnLeave_Days", countDays);
        } else {
             oListItem.set_item("OnLeave", "");oListItem.set_item("OnLeave_Days", "");
        }
    }
    oListItem.set_item("Role", lkaddRoleValue);
...
function updateListItem(siteMainUrl, lstName, addSiteValue, stringDate, monthField, yearField, itemID, newDateFieldRange, deliveryNoteDataField, cylScanDataField, scmDataField, qBotDataField, iBotDataField, datalakeDataField, rpaDataField, ioTDataField, enterprisePortalDataField,agencyDataField,allProjectsDataField,onLeaveDataField) {
    ...
    oListItem = oList.getItemById(itemID);
     ...
     if (addSiteValue == "Delivery Note") {
			...
			var totalDays=getTotalDays(stringDate);
            oListItem.set_item("DeliveryNote_Days", totalDays);
        }
		else {
             oListItem.set_item("DeliverNote", "");oListItem.set_item("DeliveryNote_Days","");
        ...
        if (cylScanDataField != "" && cylScanDataField != "null") {
			...
			var totalDays=getTotalDays(cylScanDataField);
			oListItem.set_item("CylScan_Days",totalDays);
        } 
		else {
             oListItem.set_item("CylScan", "");oListItem.set_item("CylScan_Days","");
        }
        if (scmDataField != "" && scmDataField != "null") {
			...
			var totalDays=getTotalDays(scmDataField);
			oListItem.set_item("SCM_Days",totalDays);
        }
		else {
            oListItem.set_item("SCM_x0020_FM", "");oListItem.set_item("SCM_Days","");oListItem.set_item("SCM_Days","");
        }
        if (qBotDataField != "" && qBotDataField != "null") {
			var totalDays=getTotalDays(qBotDataField);
			oListItem.set_item("QBot", qBotDataField);
			oListItem.set_item("QBot_Days",totalDays);
        } else {
            oListItem.set_item("QBot", "");oListItem.set_item("QBot_Days","");oListItem.set_item("QBot_Days","");
        }
        if (iBotDataField != "" && iBotDataField != "null") {
			var totalDays=getTotalDays(iBotDataField);
			oListItem.set_item("IBot_Days",totalDays);
            oListItem.set_item("IBot", iBotDataField);
			
        } else {
           oListItem.set_item("IBot", "");oListItem.set_item("IBot_Days","");oListItem.set_item("IBot_Days","");
        }
        if (datalakeDataField != "" && datalakeDataField != "null") {
			var totalDays=getTotalDays(datalakeDataField);
			oListItem.set_item("DataLake_Days",totalDays);
        ...
        if (rpaDataField != "" && rpaDataField != "null") {
			var totalDays=getTotalDays(rpaDataField);
			oListItem.set_item("RPA_Days",totalDays);
            oListItem.set_item("RPA", rpaDataField);
			
        } else {
            oListItem.set_item("RPA", "");oListItem.set_item("RPA_Days","");oListItem.set_item("RPA_Days","");
        }
        if (ioTDataField != "" && ioTDataField != "null") {
			
            oListItem.set_item("IoT", ioTDataField);
			var totalDays=getTotalDays(ioTDataField);
			oListItem.set_item("IoT_Days",totalDays);
        } else {
             oListItem.set_item("IoT", "");oListItem.set_item("IoT_Days", "");
        }
        if (enterprisePortalDataField != "" && enterprisePortalDataField != "null") {
			var totalDays=getTotalDays(enterprisePortalDataField);
			oListItem.set_item("EnterprisePortal_Days",totalDays);
		...
		if (agencyDataField != "" && agencyDataField != "null") {
			var totalDays=getTotalDays(agencyDataField);
			oListItem.set_item("Agency_Days",totalDays);
        ...
        if (allProjectsDataField != "" && allProjectsDataField != "null") {
			...
			var totalDays=getTotalDays(allProjectsDataField);
			oListItem.set_item("AllProjects_Days",totalDays);
        } else {
            oListItem.set_item("AllProjects", "");oListItem.set_item("AllProjects_Days","");
        }
		 if (onLeaveDataField != "" && onLeaveDataField != "null") {
			var totalDays=getTotalDays(onLeaveDataField);
			oListItem.set_item("OnLeave_Days",totalDays);
    ...
    if (addSiteValue == "CylScan") {
       ...
       if (deliveryNoteDataField != "" && deliveryNoteDataField != "null") {
			...
			var totalDays=getTotalDays(deliveryNoteDataField);
            oListItem.set_item("DeliveryNote_Days", totalDays);
        }
		else {
             oListItem.set_item("DeliverNote", "");oListItem.set_item("DeliveryNote_Days","");
...
function renderInit() {
    ...
    renderMonthTdHTML = "";
    renderTableHTML += '<th style="font-size:16px;width:100%">EmployeeName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>';
...
function getTotalDays(arr){
	var daysDel=arr.split(';');
			 var countDays=0;
				for(i=0;i<daysDel.length;i++){
				if(daysDel[i]!="null"){
				countDays=countDays+1;
				}
